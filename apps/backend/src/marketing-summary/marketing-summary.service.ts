...
const RISK_FEE_RATE = 0.1; // 10% of total cost
...
export interface MarketingSummaryProductRow {
  ...
  /** revenue_estimate - revenue_tax - total_cost - risk_fee - total_delivery_fee - tax_ads. */
  profit: number;
...
export class MarketingSummaryService {
  ...
  private buildRows(
    ...
    for (const pid of productIds) {
      ...
      const riskFee = totalCost * RISK_FEE_RATE;
